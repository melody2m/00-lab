...
function displayPics(){
  ...
  // the variable rando is defined within the scope of the code-block of the while loop, because it is block-scoped. It is local to that code block and undefined outside it, which is where the console log attempts to call it. 
